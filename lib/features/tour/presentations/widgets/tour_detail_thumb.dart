...
class TourDetailThumb extends StatefulWidget {
  ...
  const TourDetailThumb({super.key, this.minShowedImages = minimunShowedImage});
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<TourBloc, TourState>(
      builder: (context, state) {
        print(state);
        if (state is TourInitial || state is TourActionLoading) {
            ...
            child: Stack(
              ...
              children: [
                CarouselSlider.builder(
                  ...
                  itemCount: min(tour!.imageUrls.length, minimunShowedImage),
